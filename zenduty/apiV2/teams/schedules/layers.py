...
class LayersBuilder(object):
    ...
    def add_layer(self, name: str, users: list[str], restrictions: list[Restriction],rotation_start_time: datetime, rotation_end_time:datetime, shift_length: timedelta, restriction_type: int , timezone: str) -> object:
        self.layers.append({
            "name": name,
