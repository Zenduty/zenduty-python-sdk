...
client = ZendutyClient(
    credential=cred, use_https=True
...
sla = sla_client_for_team.create_sla(
    name="SLA-001", is_active=True, acknowledge_time=10, resolve_time=10
)
print("Created SLA...")
print(sla)
...
tt = task_template_client_for_team.create_task_template(
    name="Task-001", summary="Task template"
)
...
priority = priority_client_for_team.create_priority(
    name="Priority-001", color="red", description="Description for priority-001"
)
